...
for i in range (4):
    ...
    if _2or4 == 2 :
        print('For "'+liste_q[i][2]+'" press 1')
        print('For "'+liste_q[i][1]+'" press 2')
    ...
    if _2or4 == 4 :
        print('For "'+liste_q[i][4]+'" press 1')
        print('For "'+liste_q[i][2]+'" press 2')
        print('For "'+liste_q[i][3]+'" press 3')
        print('For "'+liste_q[i][1]+'" press 4')
